...
namespace JelL_0._1 {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(int Id, string Name, string Login, string Pass, string Admin) {
...
namespace JelL_0._1.DatabaseDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Login] = @Original_Login) AND ([Pass] = @Original_Pass) AND ((@IsNull_" +
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Admin", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Admin", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Id], [Name], [Login], [Pass], [Admin]) VALUES (@Id, @" +
                "Name, @Login, @Pass, @Admin);\r\nSELECT Id, Name, Login, Pass, Admin FROM Users WH" +
                "ERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [Name] = @Name, [Login] = @Login, [Pass] = @Pass, [Admin] = @Admin WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Login] = @Original_Login) AND ([Pass] = @Original_Pass) AND ((@IsNull_Admin = 1 AND [Admin] IS NULL) OR ([Admin] = @Original_Admin)));
SELECT Id, Name, Login, Pass, Admin FROM Users WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Admin", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Admin", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::JelL_0._1.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Login, Pass, Admin FROM dbo.Users";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Login, string Original_Pass, string Original_Admin) {
            ...
            if ((Original_Admin == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Admin));
            }
        ...
        public virtual int Insert(int Id, string Name, string Login, string Pass, string Admin) {
        ...
        public virtual int Update(int Id, string Name, string Login, string Pass, string Admin, int Original_Id, string Original_Name, string Original_Login, string Original_Pass, string Original_Admin) {
            ...
            if ((Original_Admin == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Admin));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Login, string Pass, string Admin, int Original_Id, string Original_Name, string Original_Login, string Original_Pass, string Original_Admin) {
            return this.Update(Original_Id, Name, Login, Pass, Admin, Original_Id, Original_Name, Original_Login, Original_Pass, Original_Admin);
        }
    }
